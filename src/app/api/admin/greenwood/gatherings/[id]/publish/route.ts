...
import { adminPublishGathering } from "@/lib/greenwood/gatherings/admin-ops";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const gathering = await adminPublishGathering(id, identity.actorId, admin);
    ...
    console.error("[POST publish gathering]", error);
    return NextResponse.json(
