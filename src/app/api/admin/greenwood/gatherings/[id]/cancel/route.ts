...
import { adminCancelGathering } from "@/lib/greenwood/gatherings/admin-ops";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const gathering = await adminCancelGathering(
      id,
      identity.actorId,
      reason,
      admin,
    ...
    console.error("[POST cancel gathering]", error);
    return NextResponse.json(
