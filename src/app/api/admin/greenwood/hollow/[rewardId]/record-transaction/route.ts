...
import { adminRecordTransaction } from "@/lib/greenwood/hollow/campaign-ops";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const campaign = await adminRecordTransaction(
      rewardId,
      {
    ...
    console.error("[POST record-transaction]", error);
    return NextResponse.json(
