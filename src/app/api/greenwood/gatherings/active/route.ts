...
/**
 * GET /api/greenwood/gatherings/active
 * Convenience: only the currently active Fire Gathering, if any.
 */
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json(
      {
        ok: true,
        gathering: gatherings.active,
        serverNow: gatherings.serverNow,
      },
    ...
    console.error("[GET /api/greenwood/gatherings/active]", error);
    return NextResponse.json(
